-- Simplificar invocación del edge function de notificación
...
BEGIN
  ...
  -- Enviar notificación por email de forma asíncrona (usando pg_net)
  -- No bloqueamos si falla
  PERFORM net.http_post(
    url := 'https://jazjzwhbagwllensnkaz.supabase.co/functions/v1/send-role-change-notification',
