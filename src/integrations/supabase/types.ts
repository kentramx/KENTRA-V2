...
export type Database = {
  ...
  public: {
    ...
    Functions: {
      ...
      check_geohash_status: { Args: never; Returns: Json }
      ...
      get_clusters_by_geohash: {
        Args: {
          p_east: number
          p_geohash_column: string
