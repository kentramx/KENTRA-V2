...
-- Verificar conteo
SELECT status, count FROM mv_property_counts_by_status;
...
-- ============================================================================
-- PASO 4: BACKFILL GEOHASH (ejecutar múltiples veces hasta remaining = 0)
-- ============================================================================
...
-- Backfill un batch de 5000 propiedades (más pequeño para evitar timeout)
WITH batch AS (
  SELECT id
  FROM properties
...
-- ============================================================================
-- PASO 5: REFRESCAR CLUSTERS PRE-COMPUTADOS (después de backfill)
-- ============================================================================

-- Solo ejecutar después de que el backfill esté completo o tenga suficientes datos
...
-- ============================================================================
-- PASO 6: NOTIFICAR A POSTGREST PARA RECARGAR SCHEMA
-- ============================================================================

NOTIFY pgrst, 'reload schema';

-- ============================================================================
-- TEST: Verificar que search_properties es rápido (debería ser < 500ms)
-- ============================================================================
